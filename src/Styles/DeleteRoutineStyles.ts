export const DeleteRoutineStyles = {
    // --- TÍTULOS ---
    redTitle: "mt-3 text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 mb-8 tracking-tight drop-shadow-lg flex items-center justify-center gap-3",

    // --- BUSCADOR ESTILO HERO (ROJO) ---
    searchWrapper: "max-w-2xl mx-auto relative group mb-12",
