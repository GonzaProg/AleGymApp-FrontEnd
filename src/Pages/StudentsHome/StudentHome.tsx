    ...
    return (
        <div className="pt-safe mt-24 p-0 animate-fade-in pb-32 space-y-6 max-w-lg mx-auto relative">
            ...
            <div className={`relative p-4 ${fondoGymUrl ? 'overflow-hidden' : ''}`}>
                ...
                {fondoGymUrl && (
                    <div 
                        className="absolute inset-0 z-0 pointer-events-none bg-transparent bg-no-repeat bg-[length:100%_auto] bg-[35%_0%]"
                        style={{ 
            ...
            {!isUserExpired && (
                <>
                    ...
                    {fondoGymUrl && <div className="h-28 md:h-40 pointer-events-none"></div>}
